...
vim.cmd([[autocmd Filetype markdown inoremap <buffer> ,q <div align=center><img src=""></div><Enter><Enter><++><ESC>2k^f"a]])
vim.cmd([[autocmd Filetype markdown inoremap <buffer> ,x <div align=center><Enter><Enter><++><Enter><Enter></div><Enter><Enter><++><ESC>4k0c$]])
